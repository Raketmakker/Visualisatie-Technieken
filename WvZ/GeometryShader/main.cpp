...
void init()
{
	...
	std::ifstream geomShaderFile("simple.gs");
	...
	std::ifstream vertexShaderFile("simple.vs");
	...
	std::ifstream fragShaderFile("simple.fs");
...
void display()
{
	...
	glDrawArrays(GL_POINTS, 0, vertices.size());																			//en tekenen :)
